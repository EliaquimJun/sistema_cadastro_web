...
from app_recepcao.views import (
    LoginAPI,LogoutAPI,TblVisitanteViewSet, RegistroEntradaViewSet,GithubWebhookAPI,
...
urlpatterns = [
   ...
   path('github_webhook/', csrf_exempt(GithubWebhookAPI.as_view()), name='github_webhook'),
]
